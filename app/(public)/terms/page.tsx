  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-[800px] px-6 pt-6 pb-16 md:px-10">
        <h1 className="mb-2 text-[clamp(28px,4vw,42px)] font-bold leading-[1.1]">Terms of Service</h1>
        ...
        <div className="prose-sm space-y-6 text-[14px] leading-[1.8] text-[var(--poli-sub)]">
          <section>
            <h2 className="mb-2 text-[16px] font-semibold text-[var(--poli-text)]">Acceptance</h2>
            <p>By using Poli, you agree to these terms. If you don&apos;t agree, please don&apos;t use the platform.</p>
          </section>

          <section>
            <h2 className="mb-2 text-[16px] font-semibold text-[var(--poli-text)]">What Poli Is</h2>
          ...
          <section>
            <h2 className="mb-2 text-[16px] font-semibold text-[var(--poli-text)]">Accuracy Disclaimer</h2>
          ...
          <section>
            <h2 className="mb-2 text-[16px] font-semibold text-[var(--poli-text)]">Not Legal or Political Advice</h2>
          ...
          <section>
            <h2 className="mb-2 text-[16px] font-semibold text-[var(--poli-text)]">Your Account</h2>
          ...
          <section>
            <h2 className="mb-2 text-[16px] font-semibold text-[var(--poli-text)]">User Contributions</h2>
          ...
          <section>
            <h2 className="mb-2 text-[16px] font-semibold text-[var(--poli-text)]">Limitation of Liability</h2>
          ...
          <section>
            <h2 className="mb-2 text-[16px] font-semibold text-[var(--poli-text)]">Changes</h2>
          ...
          <section>
            ...
            <p>Questions? <a href="/contact" className="font-medium text-[var(--poli-text)] underline underline-offset-2">Contact us</a>.</p>
          </section>
        </div>

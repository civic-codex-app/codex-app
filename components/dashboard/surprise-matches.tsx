    ...
    <section className="mb-10">
      ...
      {!revealed ? (
        <button
          ...
          className="w-full rounded-md border border-dashed border-[var(--codex-border)] py-8 text-center transition-colors hover:border-[var(--codex-sub)] hover:bg-[var(--codex-hover)]"
        ...
        >
          ...
          <div className="mt-1 text-xs text-[var(--codex-faint)]">
          ...
          {matches.map((m) => (
            ...
            >
              ...
              <div className="flex flex-col items-end gap-0.5">
                ...
                <span className="text-[10px] text-[var(--codex-faint)]">match</span>
              </div>
            </Link>
          ))}
        </div>

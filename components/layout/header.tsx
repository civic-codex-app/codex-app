...
export function Header() {
  ...
  return (
    <header className="mx-auto max-w-[1200px] px-6 pt-7 md:px-10 md:pt-9">
      <a
        href="#main-content"
      ...
      <div className="mb-10 flex items-center justify-between border-b border-[var(--codex-border)] pb-4 md:mb-14">
